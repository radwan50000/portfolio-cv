    ...
    return (
        <>
                ...
                className='skills-section flex flex-col
                    ...
                    flex-row shrink-0'>
                            ...
                            <div
                                ...
                                <TailwindCSS />
                                <p>
                                    <bold>Tailwind CSS</bold> is used to build fast and responsive UIs directly in HTML using utility classes. Instead of writing custom CSS, developers apply pre-defined classes like bg-blue-500, p-4, or text-center to style elements. This approach speeds up development, enforces design consistency, and reduces the need for writing traditional CSS. Tailwind is especially useful in modern frontend development where rapid prototyping and clean, component-based design are priorities. It’s also highly customizable and works seamlessly with frameworks like React.
                                </p>
                            </div>
                            <div
                                className='skill-card'>
            ...
            <section
                    ...
                    className='h-dvh w-full flex flex-col pt-[15%]'
                    ref={end_skills}>
                    <div
                        className='flex w-[80%] justify-between items-center mx-auto'>
                        <div className='text-8xl leading-[90%] mx-auto text-textColor'>
                            Get in <br/>touch <span className='text-[12rem]'>.</span>
                        </div>
